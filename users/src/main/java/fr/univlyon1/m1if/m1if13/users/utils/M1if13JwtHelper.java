...
public class M1if13JwtHelper {
     ...
     */
    public static String verifyToken(String token, @NonNull String origin) throws NullPointerException, JWTVerificationException {
     ...
     */
    private static String getOrigin(@NonNull HttpServletRequest request) {
